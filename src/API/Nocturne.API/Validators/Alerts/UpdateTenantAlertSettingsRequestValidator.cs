...
/// so the controller never reads the expiry — 400-ing a schedule-only save that merely echoed a
/// now-stale value back would reject it over a field the server ignores.</description></item>
/// </list>
/// </remarks>
